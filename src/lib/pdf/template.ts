...
export function getHtmlTemplate(report: CompetitorReport): string {
  ...
  const renderScoreValue = (score: number | null | undefined) => {
    if (score === null || score === undefined) {
      return `<span style="font-size: 7.5pt; font-weight: 700; text-align: center; line-height: 1.1; padding: 2px;">Score<br/>unavailable</span>`;
    }
...
<body>
  ...
  <div class="section" style="margin-top: 30px;">
    ...
    <div class="score-container">
      <div class="score-circle">
        <div class="score-value ${getScoreColorClass(seo.performanceScore)}">${renderScoreValue(seo.performanceScore)}</div>
        <div class="score-label">Performance</div>
      </div>
      <div class="score-circle">
        <div class="score-value ${getScoreColorClass(seo.accessibilityScore)}">${renderScoreValue(seo.accessibilityScore)}</div>
        <div class="score-label">Accessibility</div>
      </div>
      <div class="score-circle">
        <div class="score-value ${getScoreColorClass(seo.seoScore)}">${renderScoreValue(seo.seoScore)}</div>
        <div class="score-label">SEO</div>
      </div>
      <div class="score-circle">
        <div class="score-value ${getScoreColorClass(seo.bestPracticesScore)}">${renderScoreValue(seo.bestPracticesScore)}</div>
  ...
  <div class="footer">
    <div>
      Generated by CompetitorScan
      ${report.degradedMode ? `
        <span style="display: block; color: #DC2626; font-weight: 600; font-size: 7.5pt; margin-top: 4px;">
          ⚠️ Some analysis sections used a lighter AI model due to rate limits
        </span>
      ` : ""}
    </div>
